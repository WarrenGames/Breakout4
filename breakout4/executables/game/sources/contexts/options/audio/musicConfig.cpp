...
MusicConfig::MusicConfig(Essentials& essentials, const sdl2::Font& font, const TextsBlocks& audioLangTexts):
	...
	musicTxt{essentials.logs, essentials.rndWnd, font, audioLangTexts[audioLang::MUSIC], WHITE_COL, TexturePosition{2*SQR_SIZE, 7*SQR_SIZE, false, true } },
	enabled{essentials.logs, essentials.rndWnd, font, audioLangTexts[audioLang::ENABLED], WHITE_COL, TexturePosition{4*SQR_SIZE, 7*SQR_SIZE, false, true} },
	disabled{essentials.logs, essentials.rndWnd, font, audioLangTexts[audioLang::DISABLED], WHITE_COL, TexturePosition{4*SQR_SIZE, 7*SQR_SIZE, false, true} },
	volBar{essentials, {2*SQR_SIZE, 9*SQR_SIZE, VOL_GRADIENT_W, VOL_GRADIENT_H}, GREEN_COL, RED_COL, Offset{0, MIX_MAX_VOLUME}, MIX_MAX_VOLUME/2},
	playMusic{essentials.logs, essentials.rndWnd, font, "Play music", GREEN_COL, MEDIUM_GRAY_COL, SQR_SIZE * 4, SQR_SIZE * 8, true},
	switchMusicBool{essentials.logs, essentials.rndWnd, font, "Enable/disable music", GREEN_COL, MEDIUM_GRAY_COL, SQR_SIZE * 8, SQR_SIZE * 7, true}
{
