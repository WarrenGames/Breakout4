...
{
	if( menu.isButtonClicked(optionsMenu::BTN_LANGUAGE) )
	{
...
{
	if( menu.isButtonClicked(optionsMenu::BTN_GRAPHICS) )
	{
...
{
	if( menu.isButtonClicked(optionsMenu::BTN_SOUNDS) )
	{
...
{
	if( menu.isButtonClicked(optionsMenu::BTN_MUSIC) )
	{
		audioOptions::mainContext(essentials);
		essentials.inp.setMouseButtonToFalse(SDL_BUTTON_LEFT);
	}
...
{
	if( menu.isButtonClicked(optionsMenu::BTN_QUIT) )
	{
		quitMenu = true;
	}
}