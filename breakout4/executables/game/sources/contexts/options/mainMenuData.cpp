...
{
	categoriesTexts.emplace_back( TextButton{essentials.logs, essentials.rndWnd, fancyFont, languagesTexts[optionsMenu::TXT_LANGUAGE_MENU], 
												GREEN_COL, WHITE_COL, GAME_SCREEN_WIDTH / 4, SQR_SIZE * 6, true} );
	categoriesTexts.emplace_back( TextButton{essentials.logs, essentials.rndWnd, fancyFont, languagesTexts[optionsMenu::TXT_GRAPHICS_MENU], 
												GREEN_COL, WHITE_COL, GAME_SCREEN_WIDTH * 3 / 4, SQR_SIZE * 6, true});
	categoriesTexts.emplace_back( TextButton{essentials.logs, essentials.rndWnd, fancyFont, languagesTexts[optionsMenu::TXT_SOUND_MENU], 
												GREEN_COL, WHITE_COL, GAME_SCREEN_WIDTH / 4, SQR_SIZE * 12, true} );
	categoriesTexts.emplace_back( TextButton{essentials.logs, essentials.rndWnd, fancyFont, languagesTexts[optionsMenu::TXT_MUSIC_MENU], 
												GREEN_COL, WHITE_COL, GAME_SCREEN_WIDTH * 3 / 4, SQR_SIZE * 12, true} );
	categoriesTexts.emplace_back( TextButton{essentials.logs, essentials.rndWnd, fancyFont, languagesTexts[optionsMenu::TXT_QUIT_MENU], 
												GREEN_COL, MEDIUM_GRAY_COL, GAME_SCREEN_WIDTH - SQR_SIZE * 3, SQR_SIZE / 2, true } );
}
