...
struct InputThings
{
	...
	std::array< HighLightButton, onePlGame::INP_MAX > keycodesInputsTexts;
	std::array< HighLightButton, onePlGame::INP_MAX > joystickInputsTexts;
	std::array< HighLightButton, onePlGame::JOY_CROSS_MOVE_MAX > moveCross;
