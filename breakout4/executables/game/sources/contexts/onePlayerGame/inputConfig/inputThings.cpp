...
onePlGame::InputThings::InputThings(Essentials& essentials):
	...
	keycodesInputsTexts{
		HighLightButton{essentials.logs, essentials.rndWnd, fancyFont, getKeycodeString(0), BLACK_COL, {SQR_SIZE*8, SQR_SIZE*3, BTN_W, BTN_H}, GREEN_COL},
		HighLightButton{essentials.logs, essentials.rndWnd, fancyFont, getKeycodeString(1), BLACK_COL, {SQR_SIZE*8, SQR_SIZE*4, BTN_W, BTN_H}, GREEN_COL},
		HighLightButton{essentials.logs, essentials.rndWnd, fancyFont, getKeycodeString(2), BLACK_COL, {SQR_SIZE*8, SQR_SIZE*5, BTN_W, BTN_H}, GREEN_COL},
		HighLightButton{essentials.logs, essentials.rndWnd, fancyFont, getKeycodeString(3), BLACK_COL, {SQR_SIZE*8, SQR_SIZE*6, BTN_W, BTN_H}, GREEN_COL},
		HighLightButton{essentials.logs, essentials.rndWnd, fancyFont, getKeycodeString(4), BLACK_COL, {SQR_SIZE*8, SQR_SIZE*7, BTN_W, BTN_H}, GREEN_COL}
	},
	joystickInputsTexts{
		HighLightButton{essentials.logs, essentials.rndWnd, fancyFont, getJoystickMoveString(), BLACK_COL, {SQR_SIZE*14, SQR_SIZE*3, BTN_W, BTN_H}, GREEN_COL},
		HighLightButton{essentials.logs, essentials.rndWnd, fancyFont, getJoystickMoveString(), BLACK_COL, {SQR_SIZE*14, SQR_SIZE*4, BTN_W, BTN_H}, GREEN_COL},
		HighLightButton{essentials.logs, essentials.rndWnd, fancyFont, getJoystickBtnString(onePlGame::JOYBTN_BALL_TRACE), BLACK_COL, {SQR_SIZE*14, SQR_SIZE*5, BTN_W, BTN_H}, GREEN_COL},
		HighLightButton{essentials.logs, essentials.rndWnd, fancyFont, getJoystickBtnString(onePlGame::JOYBTN_LOOK_BAG), BLACK_COL, {SQR_SIZE*14, SQR_SIZE*6, BTN_W, BTN_H}, GREEN_COL},
		HighLightButton{essentials.logs, essentials.rndWnd, fancyFont, getJoystickBtnString(onePlGame::JOYBTN_SWITCH), BLACK_COL, {SQR_SIZE*14, SQR_SIZE*7, BTN_W, BTN_H}, GREEN_COL}
	},
	moveCross{
		HighLightButton{essentials.logs, essentials.rndWnd, fancyFont, getJoystickCrossMoveString(onePlGame::JOY_CROSS_MOVE_X), BLACK_COL, {SQR_SIZE*14, SQR_SIZE*8, BTN_W, BTN_H}, GREEN_COL},
		HighLightButton{essentials.logs, essentials.rndWnd, fancyFont, getJoystickCrossMoveString(onePlGame::JOY_CROSS_MOVE_Y), BLACK_COL, {SQR_SIZE*14, SQR_SIZE*9, BTN_W, BTN_H}, GREEN_COL}
	},
