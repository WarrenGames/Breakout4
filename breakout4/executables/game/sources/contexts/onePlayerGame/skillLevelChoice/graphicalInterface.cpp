...
{
	skillButtons.emplace_back( TextButton{essentials.logs, essentials.rndWnd, fancyFont, languageTexts[onePlGame::skillChoice::TXT_EASY], GREEN_COL, WHITE_COL, 
											TexturePosition{ GAME_SCREEN_WIDTH/2, SQR_SIZE*5, true, true} } );
	skillButtons.emplace_back( TextButton{essentials.logs, essentials.rndWnd, fancyFont, languageTexts[onePlGame::skillChoice::TXT_MEDIUM], GREEN_COL, WHITE_COL, 
											TexturePosition{ GAME_SCREEN_WIDTH/2, SQR_SIZE*7, true, true} } );
	skillButtons.emplace_back( TextButton{essentials.logs, essentials.rndWnd, fancyFont, languageTexts[onePlGame::skillChoice::TXT_HARD], GREEN_COL, WHITE_COL, 
											TexturePosition{ GAME_SCREEN_WIDTH/2, SQR_SIZE*9, true, true} } );
}
