...
private:
	...
	std::array< const TextureCombo , onePlGame::CAMPAIGN_MAX > titles;
	std::vector< TextureCombo > skillsTexts;
	std::array< std::vector< TextureCombo >, onePlGame::SKILL_LEVEL_MAX > stdRaceScoresTexts;
	std::array< std::vector< TextureCombo >, onePlGame::SKILL_LEVEL_MAX > shopRaceScoresTexts;
...
private:
	void createScoresTexts(Essentials& essentials, const BestScoresData& data, std::array< std::vector< TextureCombo >, onePlGame::SKILL_LEVEL_MAX >& paramGraphics);
	void drawAccordingToCampaign(Essentials& essentials);
	void drawScores(Essentials& essentials, const std::array< std::vector< TextureCombo >, onePlGame::SKILL_LEVEL_MAX >& paramGraphics);
