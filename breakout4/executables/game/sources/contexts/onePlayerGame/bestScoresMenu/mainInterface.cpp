...
ScoresInterface::ScoresInterface(Essentials& essentials):
	...
	titles{	TextureCombo{ essentials.logs, essentials.rndWnd, fancyFont, languageTexts[SCORES_TITLE_FROM_SHOP_CAMP], MEDIUM_GRAY_COL, 
				TexturePosition{GAME_SCREEN_WIDTH/2, SQR_SIZE, true, true } },
			TextureCombo{essentials.logs, essentials.rndWnd, fancyFont, languageTexts[SCORES_TITLE_FROM_STD_CAMP], MEDIUM_GRAY_COL, 
				TexturePosition{GAME_SCREEN_WIDTH/2, SQR_SIZE, true, true} }
	},
...
void ScoresInterface::createScoresTexts(Essentials& essentials, const BestScoresData& data, std::array< std::vector< TextureCombo >, onePlGame::SKILL_LEVEL_MAX >& paramGraphics)
{
...
void ScoresInterface::drawScores(Essentials& essentials, const std::array< std::vector< TextureCombo >, onePlGame::SKILL_LEVEL_MAX >& paramGraphics)
{
