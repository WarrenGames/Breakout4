...
#include "contexts/onePlayerGame/levelComponents/hellEpisodeThings/fireBalls/fireBallGlobal.h"
...
public:
	...
	void update(spriteMove::ObjectMoving& ballMove, OnePlayerRacket& racket, const AllExplosions& explosions, const TextureCombo& ballTexture, const SoundHandler& sounds);
