...
public:
	...
	void updateSkulls(const HellSkullDrawer& skullDrawer, const ObjectMoving& ballMove, const AllExplosions& explosions, const SoundHandler& sounds);
	void withBallCollision(const HellSkullDrawer& skullDrawer, ObjectMoving& ballMove, const TextureCombo& ballTexture);
