...
onePlGame::HellSkullElement::HellSkullElement(const onePlGame::FireBallsPaths& fireBallPaths, const SkullFileData& fileData):
	...
	toLeftFireBall{ fireBallPaths.paths.getPath(hell::FB_PATH_BELL_TRAJ_LEFT) },
	toRightFireBall{ fireBallPaths.paths.getPath(hell::FB_PATH_BELL_TRAJ_RIGHT) },
	fireBallMove{ Offset{ 0, 0 } },
	fireBallStarThings{ 0, fireBall::TEXTURES_DIRECTIONS_NUMBER, 0 },
...
void onePlGame::HellSkullElement::update(const HellSkullDrawer& skullDrawer, const spriteMove::ObjectMoving& ballMove, const AllExplosions& explosions, const SoundHandler& sounds)
{
...
void onePlGame::HellSkullElement::moveFireBall()
{
	...
	{
		if( activity.pathNumber == hell::FB_PATH_BELL_TRAJ_LEFT || activity.pathNumber == hell::FB_PATH_BELL_TRAJ_RIGHT )
		{
