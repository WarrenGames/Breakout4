	...
	isLoadingPerfect{ true }
{
	...
	if( paths.getMovesCount() != hell::FB_PATH_MAX )
	{
		logs.error << "Error: the number of loaded paths is not good: " << paths.getMovesCount() << " paths loaded, and " << hell::FB_PATH_MAX << " expected.\n";
