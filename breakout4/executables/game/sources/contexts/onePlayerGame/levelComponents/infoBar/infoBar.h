...
private:
	...
	std::array< TextureCombo, infoBarTexts::MAX > barTexts;
	std::array< TextureCombo, infoBarTexts::MAX > blackSquares;
	
	std::array< bool, infoBarTexts::MAX > isGraphicalTextUpdateNeeded;
	std::array< TextureCombo, infoBarTexts::MAX > dataTexts;
