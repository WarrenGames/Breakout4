...
private:
	...
	std::array< bool, onePlGame::INP_MAX > functionsStates;
	Offset crossMove;
	bool escapeState;
	bool windowClosing;
...
public:
	...
	bool getFuncState(std::size_t funcIndex) const;//Need enum{ INP_MOVE_LEFT, INP_MOVE_RIGHT, INP_BALL_TRACE, INP_LOOK_BAG, INP_SWITCH, INP_MAX };
