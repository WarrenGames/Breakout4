...
OnePlayerRacket::OnePlayerRacket(Essentials& essentials, const PlayerData& playerData):
	glueLevel{0},
	data{playerData.racketSize, playerData.racketSpeed, GAME_SCREEN_HEIGHT - SQR_SIZE - 10 * SQR_SIZE / 64},
	standardRacket{essentials.logs, essentials.rndWnd, RACKET_IS_BLUE},
	stickyRacket{essentials.logs, essentials.rndWnd, RACKET_IS_GREEN},
	frozenRacket{essentials.logs, essentials.rndWnd, FROZEN_BLUE_RACKET}
{
	setRacketRect();
}
