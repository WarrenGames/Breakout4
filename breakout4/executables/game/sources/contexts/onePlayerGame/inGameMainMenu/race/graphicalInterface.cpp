...
{
	buttons.emplace_back( TextButton{essentials.logs, essentials.rndWnd, fancyFont, languageTexts[onePlGame::raceMainMenu::LANG_SEE_NEXT_LVL], GREEN_COL, MEDIUM_GRAY_COL, 
										TexturePosition{ SQR_SIZE*4, SQR_SIZE*14, true, true} } );
	buttons.emplace_back( TextButton{essentials.logs, essentials.rndWnd, fancyFont, languageTexts[onePlGame::raceMainMenu::LANG_RUN_LVL], GREEN_COL, MEDIUM_GRAY_COL, 
										TexturePosition{ SQR_SIZE*4, SQR_SIZE*12, true, true} });
	buttons.emplace_back( TextButton{essentials.logs, essentials.rndWnd, fancyFont, languageTexts[onePlGame::raceMainMenu::LANG_SAVE_GAME], GREEN_COL, MEDIUM_GRAY_COL, 
										TexturePosition{ GAME_SCREEN_WIDTH / 2, SQR_SIZE*14, true, true} } );
	buttons.emplace_back( TextButton{essentials.logs, essentials.rndWnd, fancyFont, languageTexts[onePlGame::raceMainMenu::LANG_CHANGE_INP], GREEN_COL, MEDIUM_GRAY_COL, 
										TexturePosition{ GAME_SCREEN_WIDTH / 2, SQR_SIZE*12, true, true} } );
	buttons.emplace_back( TextButton{essentials.logs, essentials.rndWnd, fancyFont, languageTexts[onePlGame::raceMainMenu::LANG_QUIT], GREEN_COL, MEDIUM_GRAY_COL, 
