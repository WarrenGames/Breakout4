...
{
	if( interface.buttons[onePlGame::raceMainMenu::BTN_CHANGE_INP].buttonClicked() )
	{
...
{
	if( essentials.inp.getKeyState(input::KEYB_OUT) || essentials.inp.getSDL_quit() || interface.buttons[onePlGame::raceMainMenu::BTN_QUIT].buttonClicked() )
	{
...
{
	if( interface.buttons[onePlGame::raceMainMenu::BTN_RUN_LVL].buttonClicked() )
	{
		essentials.inp.setMouseButtonToFalse(SDL_BUTTON_LEFT);
...
{
	if( interface.shopButton.buttonClicked() && onePlGame::CAMPAIGN_WITH_SHOP == playerData.gameType )
	{
		essentials.inp.setMouseButtonToFalse(SDL_BUTTON_LEFT);
...
{
	if( interface.buttons[onePlGame::raceMainMenu::BTN_SEE_NEXT_LVL].buttonClicked() )
	{
		essentials.inp.setMouseButtonToFalse(SDL_BUTTON_LEFT);
...
{
	if( interface.buttons[onePlGame::raceMainMenu::BTN_SAVE_GAME].buttonClicked() )
	{
		essentials.inp.setMouseButtonToFalse(SDL_BUTTON_LEFT);
