...
duels::InputScreenGlobal::InputScreenGlobal(Essentials& essentials):
	...
	playerTitles{
		TextureCombo{essentials.logs, essentials.rndWnd, fancyFont, languageTexts[duels::TXT_BLUE_PLAYER], BLACK_COL, 
						TexturePosition{SQR_SIZE*9, SQR_SIZE* 3 + SQR_SIZE/2, true, true } },
		TextureCombo{essentials.logs, essentials.rndWnd, fancyFont, languageTexts[duels::TXT_RED_PLAYER], BLACK_COL, 
