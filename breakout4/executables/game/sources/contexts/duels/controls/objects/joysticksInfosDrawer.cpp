...
{
	infosTexts.emplace_back( JoyInfosTextsGraphics{logs, rndWnd, fancyFont, duels::PLAYER_BLUE, texts} );
	infosTexts.emplace_back( JoyInfosTextsGraphics{logs, rndWnd, fancyFont, duels::PLAYER_RED, texts} );
}
