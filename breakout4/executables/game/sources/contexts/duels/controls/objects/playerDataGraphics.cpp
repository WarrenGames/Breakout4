...
PlayerInputButtons::PlayerInputButtons(AppLogFiles& logs, sdl2::RendererWindow& rndWnd, const sdl2::Font& fancyFont, const duels::ReadyToUseInputs& inputs, const TextsBlocks& texts):
	mustUpdateDeviceType( duels::PLAYER_MAX, false),
	mustTexturesBeUpdated{{
		{ false, false, false, false},
		{ false, false, false, false}
	}},
	pushKeyPrompt{logs, rndWnd, fancyFont, texts[duels::TXT_PUSH_KEY], BLACK_COL, TexturePosition{GAME_SCREEN_WIDTH / 2, GAME_SCREEN_HEIGHT - SQR_SIZE * 4, true, true} },
	pushJoystickButtonPrompt{logs, rndWnd, fancyFont, texts[duels::TXT_PUSH_JOYBTN], BLACK_COL, TexturePosition{GAME_SCREEN_WIDTH / 2, GAME_SCREEN_HEIGHT - SQR_SIZE * 4, true, true } }
{
...
{
	deviceTypeBtn.emplace_back(HighLightButton{logs, rndWnd, fancyFont, duels::getStringFromDeviceType(inputs.playerEnt[duels::PLAYER_BLUE], texts), BLACK_COL, 
												SDL_Rect{7*SQR_SIZE, 4*SQR_SIZE, HL_BTN_W, HL_BTN_H}, ORANGE_COL} );
	deviceTypeBtn.emplace_back(HighLightButton{logs, rndWnd, fancyFont, duels::getStringFromDeviceType(inputs.playerEnt[duels::PLAYER_RED], texts), BLACK_COL, 
												SDL_Rect{12*SQR_SIZE, 4*SQR_SIZE, HL_BTN_W, HL_BTN_H}, ORANGE_COL} );
}
...
{
	for( std::size_t i{0} ; i < duels::PLAYER_MAX ; ++i )
	{
		inputsButtons.emplace_back( std::vector< HighLightButton >() );
	}
	
	inputsButtons[duels::PLAYER_BLUE].emplace_back( HighLightButton{ logs, rndWnd, fancyFont, duels::getStringFromLeftMove(inputs.playerEnt[duels::PLAYER_BLUE], texts), BLACK_COL, 
																	SDL_Rect{7*SQR_SIZE, 5*SQR_SIZE, HL_BTN_W, HL_BTN_H}, ORANGE_COL} );
	inputsButtons[duels::PLAYER_BLUE].emplace_back( HighLightButton{ logs, rndWnd, fancyFont, duels::getStringFromRightMove(inputs.playerEnt[duels::PLAYER_BLUE], texts), BLACK_COL, 
																	SDL_Rect{7*SQR_SIZE, 6*SQR_SIZE, HL_BTN_W, HL_BTN_H}, ORANGE_COL} );
	inputsButtons[duels::PLAYER_BLUE].emplace_back( HighLightButton{ logs, rndWnd, fancyFont, duels::getStringFromActiveBonus(inputs.playerEnt[duels::PLAYER_BLUE], texts), BLACK_COL, 
																	SDL_Rect{7*SQR_SIZE, 7*SQR_SIZE, HL_BTN_W, HL_BTN_H}, ORANGE_COL} );
	inputsButtons[duels::PLAYER_BLUE].emplace_back( HighLightButton{ logs, rndWnd, fancyFont, duels::getStringFromZoneSpecific(inputs.playerEnt[duels::PLAYER_BLUE], texts), BLACK_COL, 
																	SDL_Rect{7*SQR_SIZE, 8*SQR_SIZE, HL_BTN_W, HL_BTN_H}, ORANGE_COL} );
	
	inputsButtons[duels::PLAYER_RED].emplace_back( HighLightButton{ logs, rndWnd, fancyFont, duels::getStringFromLeftMove(inputs.playerEnt[duels::PLAYER_RED], texts), BLACK_COL, 
																	SDL_Rect{12*SQR_SIZE, 5*SQR_SIZE, HL_BTN_W, HL_BTN_H}, ORANGE_COL} );
	inputsButtons[duels::PLAYER_RED].emplace_back( HighLightButton{ logs, rndWnd, fancyFont, duels::getStringFromRightMove(inputs.playerEnt[duels::PLAYER_RED], texts), BLACK_COL, 
																	SDL_Rect{12*SQR_SIZE, 6*SQR_SIZE, HL_BTN_W, HL_BTN_H}, ORANGE_COL} );
	inputsButtons[duels::PLAYER_RED].emplace_back( HighLightButton{ logs, rndWnd, fancyFont, duels::getStringFromActiveBonus(inputs.playerEnt[duels::PLAYER_RED], texts), BLACK_COL, 
																	SDL_Rect{12*SQR_SIZE, 7*SQR_SIZE, HL_BTN_W, HL_BTN_H}, ORANGE_COL} );
	inputsButtons[duels::PLAYER_RED].emplace_back( HighLightButton{ logs, rndWnd, fancyFont, duels::getStringFromZoneSpecific(inputs.playerEnt[duels::PLAYER_RED], texts), BLACK_COL, 
																	SDL_Rect{12*SQR_SIZE, 8*SQR_SIZE, HL_BTN_W, HL_BTN_H}, ORANGE_COL} );
}
