...
enum{ SPIN_ZONE_SPEC, SPIN_BONUSES, SPIN_OTHER_OPTIONS, SPIN_MAX };
...
struct ZoneChoiceGraphics
{
	...
	const std::array< const SDL_Color, duels::PLAYER_MAX > colors;
	const std::array< const std::string , duels::PLAYER_MAX > playersStrings;
	std::array< TextureCombo, duels::PLAYER_MAX > scoresTexts;
