...
{
	if( zoneThings.graphics.isSpinClicked(SPIN_ZONE_SPEC, essentials.inp.getMousePosition(), essentials.inp.getMouseButtonState(SDL_BUTTON_LEFT) ) )
	{
		switch( zoneThings.selectedZone )
		{
			case duels::ZONE_STD:
...
{
	if( zoneThings.graphics.isSpinClicked(SPIN_BONUSES, essentials.inp.getMousePosition(), essentials.inp.getMouseButtonState(SDL_BUTTON_LEFT) ) )
	{
