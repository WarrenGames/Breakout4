...
HalloweenSpecElements::HalloweenSpecElements(AppLogFiles& logs, sdl2::RendererWindow& rndWnd, const TextsBlocks& langTexts, const sdl2::Font& arial, HalloweenConfig& halloweenConfig):
	pumpkins{
		TextureCombo{logs, rndWnd, "textures/gameZones/halloween/pumpkinRed.png", TexturePosition{SQR_SIZE, SQR_SIZE * 3 + SQR_SIZE / 2, true, true} },
		TextureCombo{logs, rndWnd, "textures/gameZones/halloween/pumpkinGray.png", TexturePosition{SQR_SIZE, SQR_SIZE * 5 + SQR_SIZE / 2,true, true} },
		TextureCombo{logs, rndWnd, "textures/gameZones/halloween/pumpkinBlue.png", TexturePosition{SQR_SIZE, SQR_SIZE * 7 + SQR_SIZE / 2, true, true} },
		TextureCombo{logs, rndWnd, "textures/gameZones/halloween/pumpkinYellow.png", TexturePosition{SQR_SIZE, SQR_SIZE * 9 + SQR_SIZE / 2, true, true} }
	},
	explanationsAboutPumpkins{
		TextureCombo{logs, rndWnd, arial, langTexts[language::halloween::RED_PUMPKIN], WHITE_COL, TexturePosition{SQR_SIZE * 7, SQR_SIZE * 3 + SQR_SIZE / 2, false, true} }, 
		TextureCombo{logs, rndWnd, arial, langTexts[language::halloween::GRAY_PUMPKIN], WHITE_COL, TexturePosition{SQR_SIZE * 7, SQR_SIZE * 5 + SQR_SIZE / 2, false, true} }, 
		TextureCombo{logs, rndWnd, arial, langTexts[language::halloween::BLUE_PUMPKIN], WHITE_COL, TexturePosition{SQR_SIZE * 7, SQR_SIZE * 7 + SQR_SIZE / 2, false, true} }, 
		TextureCombo{logs, rndWnd, arial, langTexts[language::halloween::YELLOW_PUMPKIN], WHITE_COL, TexturePosition{SQR_SIZE * 7, SQR_SIZE * 9 + SQR_SIZE / 2, false, true} }
	},
