...
void collision::makeObjectMoveBounceWithRect(ObjectMoving& objectMove, const SpriteSize& objectSize, const SDL_Rect& rect)
{
...
void collision::checkYPosition(ObjectMoving& objectMove, const SpriteSize& objectSize, const SDL_Rect& rect)
{
