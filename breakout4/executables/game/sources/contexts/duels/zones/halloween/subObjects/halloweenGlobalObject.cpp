...
duels::HalloweenPack::HalloweenPack(Essentials& essentials, const duels::LevelOptions& levelOptions):
	arial{essentials.logs.error, ARIALFONTPATH, FONT_BIG_PTSIZE},
...
{
	zonesCommon.update(area.levelGrid, levelOptions, quitZone, {true, true}, {true, true}, {factory.canActivateSpecialBonus(duels::PLAYER_BLUE), 
																							factory.canActivateSpecialBonus(duels::PLAYER_RED)} );
