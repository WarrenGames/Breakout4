...
PlayersThings::PlayersThings(AppLogFiles& logs, const PrefPathFinder& prefPath, sdl2::RendererWindow& rndWnd, const sdl2::Font& arialFont, const duels::LevelOptions& levelOptions):
	rackets{
		PlayerRacket{logs, rndWnd, GAME_SCREEN_HEIGHT - SQR_SIZE - SQR_SIZE * 10 / 64, RACKET_IS_BLUE, duels::RACKET_DEFAULT_SPEED},
		PlayerRacket{logs, rndWnd, SQR_SIZE, RACKET_IS_RED, duels::RACKET_DEFAULT_SPEED}
	},
	bonusGenerator{
		BonusGenerator{logs, rndWnd, duels::PLAYER_BLUE, levelOptions.bonuses},
		BonusGenerator{logs, rndWnd, duels::PLAYER_RED, levelOptions.bonuses}
	},
	racketsSpeedGradients{
		sdl2::VerticalGradient{logs, rndWnd, 	static_cast<unsigned>(rackets[duels::PLAYER_BLUE].getSpeed()-duels::RACKET_MIN_SPEED), 
												static_cast<unsigned>(duels::RACKET_MAX_SPEED-duels::RACKET_MIN_SPEED), 
												duels::BLUE_SPD_GRAD_RECT, BLUE_COL, DARK_BLUE, true},
		sdl2::VerticalGradient{logs, rndWnd, 	static_cast<unsigned>(rackets[duels::PLAYER_RED].getSpeed()-duels::RACKET_MIN_SPEED), 
												static_cast<unsigned>(duels::RACKET_MAX_SPEED-duels::RACKET_MIN_SPEED), 
												duels::RED_SPD_GRAD_RECT, RED_COL, DARK_RED, true}
	},
	gradientBackgrounds{
		TextureCombo{logs, rndWnd, BLACK_COL, duels::BLUE_SPD_GRAD_RECT.w, duels::BLUE_SPD_GRAD_RECT.h, TexturePosition{duels::BLUE_SPD_GRAD_RECT.x, duels::BLUE_SPD_GRAD_RECT.y} },
		TextureCombo{logs, rndWnd, BLACK_COL, duels::RED_SPD_GRAD_RECT.w, duels::RED_SPD_GRAD_RECT.h, TexturePosition{duels::RED_SPD_GRAD_RECT.x, duels::RED_SPD_GRAD_RECT.y} }
	},
	scoresDrawing{
		duels::ScoreDraw{logs, rndWnd, arialFont, Offset{ GAME_SCREEN_WIDTH - SQR_SIZE - SQR_SIZE / 2, GAME_SCREEN_HEIGHT - SQR_SIZE / 2}, levelOptions.playersScores[duels::PLAYER_BLUE] },
		duels::ScoreDraw{logs, rndWnd, arialFont, Offset{ GAME_SCREEN_WIDTH - SQR_SIZE - SQR_SIZE / 2, SQR_SIZE / 2},				 levelOptions.playersScores[duels::PLAYER_RED] }
	},
