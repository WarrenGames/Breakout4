...
private:	
	std::array< duels::ComboBallData, duels::BALL_MAX > ballsData;
...
public:
	...
	void checkBallsPositionsForScore(std::array< int, duels::PLAYER_MAX>& playersScores, std::array< duels::ScoreDraw, duels::PLAYER_MAX>& scoreDrawing, unsigned& givenPoints);
	...
	void checkCollisionWithRect(const SDL_Rect& externObjectRect, std::array< bool, duels::BALL_MAX >& canCollide);
