...
duels::InputEntity::InputEntity(unsigned devType, const std::array<SDL_Keycode, KEY_MAX>& keybInp, const duels::JoystickFileData& joyInfos):
	deviceType{ devType },
	inputEffective{ false, false, false, false },
...
duels::ReadyToUseInputs::ReadyToUseInputs(AppLogFiles& logs, const PrefPathFinder& prefPath):
	...
	openedJoysticks{ sdl2::JoystickEntity{0}, sdl2::JoystickEntity{1} }
{
