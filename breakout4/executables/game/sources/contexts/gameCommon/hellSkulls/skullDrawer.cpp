...
HellSkullDrawer::HellSkullDrawer(Essentials& essentials):
	loadedTextures{essentials.logs, essentials.rndWnd, Coord2D{ hellSkull::ANIM_FRAMES_NUMBER, hellSkull::TEXTURES_DIRECTIONS_NUMBER}, hellSkull::TEXTURES_LIST_FILE },
