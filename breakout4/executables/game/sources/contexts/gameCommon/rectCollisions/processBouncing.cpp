...
bool bouncing::objectsCollide(const ObjectMoving& moveA, const SpriteSize& objAsize, const ObjectMoving& moveB, const SpriteSize& objBsize, int interval)
{
...
void bouncing::processElementsBouncing(ObjectMoving& objAmove, ObjectMoving& objBmove, const SpriteSize& objBsize)
{
...
void bouncing::objA_isToLeftOfObjB(ObjectMoving& objAmove, ObjectMoving& objBmove, const SpriteSize& Bsize)
{
...
void bouncing::objAbouncesOnB_left(ObjectMoving& objAmove, ObjectMoving& objBmove)
{
...
void bouncing::objA_isToRightOfObjB(ObjectMoving& objAmove, ObjectMoving& objBmove, const SpriteSize& Bsize)
{
...
void bouncing::objA_bouncesOnB_right(ObjectMoving& objAmove, ObjectMoving& objBmove)
{
	if( objAmove.get_x_norm() < 0 )
	{
		objAmove.reverse_x_vector();
...
void bouncing::objA_notOnLeftOrRightOfB_obj(ObjectMoving& objAmove, ObjectMoving& objBmove)
{
