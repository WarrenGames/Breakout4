...
TextsBlocks::TextsBlocks(LogFile& log, const std::string& filePath, unsigned expectedStringsNumber):
	errorString{ERROR_STR},
	isLoadingPerfect{true}
{
	if( std::ifstream languageFile{filePath} )
...
void TextsBlocks::initializeTexts(LogFile& log, const std::string& filePath, unsigned expectedStringsNumber)
{
	errorString = ERROR_STR;
	isLoadingPerfect = true;
	if( std::ifstream languageFile{ filePath } )
...
void TextsBlocks::checkExpectedLoadedTexts(LogFile& log, const std::string& filePath, unsigned expectedStringsNumber)
{
...
void TextsBlocks::checkExpectedLoadedTexts(std::string& logString, const std::string& filePath, unsigned expectedStringsNumber)
{
	if( texts.size() != expectedStringsNumber )
	{
