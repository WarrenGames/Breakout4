...
public:
	...
	void initializeTexts(LogFile& log, const std::string& filePath, unsigned expectedStringsNumber);
	operator bool () const;
...
private:
	...
	void checkExpectedLoadedTexts(LogFile& log, const std::string& filePath, unsigned expectedStringsNumber);
	void checkExpectedLoadedTexts(std::string& logString, const std::string& filePath, unsigned expectedStringsNumber);
};
