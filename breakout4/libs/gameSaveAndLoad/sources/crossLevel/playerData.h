...
struct PlayerData
{
	...
	//void readLevelNamesLines(Essentials& essentials, const std::string& levelsListPath);
	...
	bool buyABonusIfPossible(unsigned bonusIndex);
	
	std::string getLevelsPath(unsigned gameType);
