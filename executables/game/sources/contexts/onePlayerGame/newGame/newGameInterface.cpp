...
onePlGame::newGame::Interface::Interface(Essentials& essentials):
	...
	languageTexts{essentials.logs.error, path::getLanguageFile(essentials.language, file::ONE_PLAY_NEW_GAME), onePlGame::newGame::TextSkillMax},
	...
	newGameButton{essentials.logs, essentials.rndWnd, fancyFont, languageTexts[onePlGame::newGame::TextStartNewGame], GreenColor, WhiteColor, GameScreenWidth / 2, SQR_SIZE * 5, true},
	loadASavedGame{essentials.logs, essentials.rndWnd, fancyFont, languageTexts[onePlGame::newGame::TextLoadSavedGame], GreenColor, WhiteColor, GameScreenWidth / 2, SQR_SIZE * 7, true},
	seeDoneScores{essentials.logs, essentials.rndWnd, fancyFont, languageTexts[onePlGame::newGame::TextSeeDoneScores], GreenColor, WhiteColor, GameScreenWidth / 2, SQR_SIZE * 9, true},
	goBackButton{essentials.logs, essentials.rndWnd, fancyFont, languageTexts[onePlGame::newGame::TextGoBack], GreenColor, WhiteColor, GameScreenWidth / 2, SQR_SIZE * 12, true},
