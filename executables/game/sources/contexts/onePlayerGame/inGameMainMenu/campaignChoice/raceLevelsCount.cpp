...
RaceLevelsCount::RaceLevelsCount(Essentials& essentials, const std::string& mainFilePath):
	levelsCount{0},
...
void RaceLevelsCount::loadFile(Essentials& essentials, const std::string& mainFilePath)
{
