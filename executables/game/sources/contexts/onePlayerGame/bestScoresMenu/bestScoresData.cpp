...
void BestScoresData::loadScoresList(Essentials& essentials, unsigned skillNumber, const fs::path& scoreFilePath)
{
...
void BestScoresData::saveScoresToFile(Essentials& essentials, const fs::path& scoreFilePath, unsigned skill) const
{
