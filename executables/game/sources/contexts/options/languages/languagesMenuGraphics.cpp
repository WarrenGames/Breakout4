...
LanguageOptionsGraphics::LanguageOptionsGraphics(Essentials& essentials):
	...
	langIndex{0},
	languagesStrings{essentials.logs.error, path::getLanguageFile(essentials.language, file::OptionMenuLanguagePanel), OptionLanguagePanelMax},
...
void LanguageOptionsGraphics::loadAvailableLanguages(Essentials& essentials, const fs::path& languagesListPath)
{
