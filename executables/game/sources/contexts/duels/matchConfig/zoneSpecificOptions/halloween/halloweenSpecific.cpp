...
{
	if( const TextsBlocks halloSpecTexts{essentials.logs.error, path::getLanguageFile(essentials.language, file::DUELS_ZoneHalloween_CFG), language::halloween::Max} )
	{
