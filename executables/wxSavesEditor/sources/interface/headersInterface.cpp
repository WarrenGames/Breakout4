...
void HeaderInterface::setTextCtrlDataFromGameSlot(const GameSlotData& slot)
{
...
void HeaderInterface::copyTextCtrlToSlot(std::size_t index, const std::string& itemDescription, std::string& text) const
{
	assert( index < count.size() );
