...
{
private:
	ConstAnimDraw generic;
	ConstAnimDraw rich;
	sdl2::Sprite bonusBrick;
	ConstAnimDraw giftBricks;
	ConstAnimDraw tenPtsBricks;
	ConstAnimDraw hardBricks;
	sdl2::Sprite iceCubeBrick;
	sdl2::Sprite pinguinBrick;
	sdl2::Sprite skullBrick;
	ConstAnimDraw lavaStoneBricks;

public:
	explicit OnePBricksTextures(BricksTexturesLoader& texturesLoader);
