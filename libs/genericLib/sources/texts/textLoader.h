...
public:
	...
	explicit TextsBlocks(LogFile& log, const std::string& filePath, std::size_t expectedStringsNumber);
	...
	void initializeTexts(LogFile& log, const std::string& filePath, std::size_t expectedStringsNumber);
	operator bool () const;
...
private:
	...
	void checkExpectedLoadedTexts(LogFile& log, const std::string& filePath, std::size_t expectedStringsNumber);
	void checkExpectedLoadedTexts(std::string& logString, const std::string& filePath, std::size_t expectedStringsNumber);
};
