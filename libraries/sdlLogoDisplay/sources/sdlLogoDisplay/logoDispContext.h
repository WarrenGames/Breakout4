...
namespace logoDisplay{
	...
	void loopThings(sdl2::RendererWindow& rndWnd, bool& quitLogoDisplay, const TextureCombo& sdlLogo, const SDL_VersionDisplay& versionDisplay, AccurateTimeDelay& displayDelay);
