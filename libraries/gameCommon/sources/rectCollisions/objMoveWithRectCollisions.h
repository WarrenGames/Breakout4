...
void startCollisionTest(spriteMove::ObjectMoving& objAMoving, const SpriteSize& objASize, const SDL_Rect& objBRect, int cornerInterval, const SoundPlayer& soundPlayer, 
