#include "duels/matchConfig/bonusesSlots/bonusInterface.h"
...
duels::BonusesInterface::BonusesInterface(Essentials& essentials):
	languagesTexts{essentials.logs.error, path::getLanguageFile(essentials.language, file::DuelsBonusSlotBase), BonusPresetMax},
