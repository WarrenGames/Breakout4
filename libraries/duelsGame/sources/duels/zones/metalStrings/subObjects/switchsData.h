...
struct SingleSwitch
{
	...
	SingleSwitch(std::size_t width, std::size_t height, unsigned playerIndex);
	~SingleSwitch() = default;
	SingleSwitch( const SingleSwitch& ) = default;
	SingleSwitch& operator= ( const SingleSwitch& ) = default;
	SingleSwitch( SingleSwitch&& ) = default;
	SingleSwitch& operator= ( SingleSwitch&& ) = default;
};
