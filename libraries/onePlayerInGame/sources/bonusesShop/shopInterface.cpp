#include "bonusesShop/shopInterface.h"
...
onePlayerShop::ShopInterface::ShopInterface(Essentials& essentials, const PlayerData& playerData):
	bonusesTexts{essentials.logs.error, path::getLanguageFile(essentials.language, file::OnePlayerBagBonuses), onePlGame::BonusMax},
