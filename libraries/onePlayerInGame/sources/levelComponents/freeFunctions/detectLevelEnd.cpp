...
void detectLiveLossWithScreenBottom(BallThings& ball, unsigned& levelEndType, PlayerData& playerData, const SoundHandler& sounds, InfoBar& infoBar, PlayedTimeCounter& playedTimeCounter)
{
