...
namespace hellCol{
	...
	void collideWithSkullHellBrick(LevelComponents& comp, const Offset& brickCoord, bool isBallPowerful, PlayerData& playerData, unsigned soundEnum);
	
	void collideWithLavaStoneBrick(LevelComponents& comp, unsigned soundEnum);
}
