...
public:
	...
	void playRecordedQuackSounds(demos::DemoAntarcticPackage& antarcticPackage, const SoundHandler& sounds);
	...
	void makePinguinsQuack(const SDL_Rect& racketRect, bool playerLeftState, bool playerRightState, const SoundHandler& sounds, demos::DemoAntarcticPackage& antarcticPackage);
