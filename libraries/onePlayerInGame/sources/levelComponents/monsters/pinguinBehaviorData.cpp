											...
											demos::DemoAntarcticPackage& antarcticPackage)
{
	...
	{
		quackFromItsLeft(racketRect, pinguinRect, playerRightState, sounds, antarcticPackage);
		quackFromItsRight(racketRect, pinguinRect, playerLeftState, sounds, antarcticPackage);
	}
}

void PinguinBehaviorData::quackFromItsLeft(const SDL_Rect& racketRect, const SDL_Rect& pinguinRect, bool playerRightState, const SoundHandler& sounds, 
												demos::DemoAntarcticPackage& antarcticPackage)
{
...
void PinguinBehaviorData::quackFromItsRight(const SDL_Rect& racketRect, const SDL_Rect& pinguinRect, bool playerLeftState, const SoundHandler& sounds, demos::DemoAntarcticPackage& antarcticPackage)
{
...
void PinguinBehaviorData::makeBounceWithRimRect(const SDL_Rect& rimRect, const SDL_Rect& pinguinRect, const SoundHandler& sounds)
{
	...
	{
		rectCollision::startCollisionTest(drawingData.move, SpriteSize{pinguinRect.w, pinguinRect.h}, rimRect, CollisionInterval, sounds, onePlGame::SoundBallWBgCollision);
	}
}
...
void PinguinBehaviorData::emplaceQuackSoundToStack(demos::DemoAntarcticPackage& antarcticPackage) const
{
	if( antarcticPackage.demoKind == demos::GameIsRecording )
	{
		antarcticPackage.pinguinsQuacks.emplaceElement(demos::SoundStackData{ antarcticPackage.pinguinsQuacks.getCurrentElapsedMicroSecondsTime(), onePlGame::SoundQuack} );
	}
}