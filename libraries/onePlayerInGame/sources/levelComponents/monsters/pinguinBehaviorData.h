...
public:
	...
	void quackFromItsLeft(const SDL_Rect& racketRect, const SDL_Rect& pinguinRect, bool playerRightState, const SoundHandler& sounds, demos::DemoAntarcticPackage& antarcticPackage);
	void quackFromItsRight(const SDL_Rect& racketRect, const SDL_Rect& pinguinRect, bool playerLeftState, const SoundHandler& sounds, demos::DemoAntarcticPackage& antarcticPackage);
